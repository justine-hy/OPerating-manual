...
#### **Week 2: Committee feedback (`[Review]`)**
...
In the event that valid votes are not able to be registerd via Snapshot, the Foundation will accept votes that are verifiable on-chain, but did not propagate to Snapshot.
